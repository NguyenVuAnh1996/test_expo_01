...
import {TouchableOpacity, Text, View, ViewProps, StyleProp, ViewStyle, TextStyle} from 'react-native';
...
const BasicDay = (props: BasicDayProps) => {
  ...
  const getContainerStyle = () => {
    ...
    const styles: StyleProp<ViewStyle> = [style.current.base];
  ...
  const getTextStyle = () => {
    ...
    const styles: StyleProp<TextStyle> = [style.current.text];
  ...
  const renderContainer = () => {
    ...
    return (
      ...
      >
        {isMultiPeriod ? renderTextGregorian() : renderContent()}
      </TouchableOpacity>
    );
  };
